...
- 首页显示宿舍余电，另有「宿舍用电」页查看楼栋、房间、剩余及已用电量；也可让夏柠读出最近一次查询结果。
...
![首页余电模拟预览](docs/previews/home-electricity.png)
...
仓库包含用户选定角色头像的黑白像素版本，不适用根目录 MIT 授权；设备的私人配置未公开。角色及相关图像的权利归相应权利人，复用或再分发前请自行确认授权。
